                            ...
                            <div class="card-product grid" data-availability="In stock" data-brand="Ecomus">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{asset('ecomas/images/products/orange-1.jpg')}}" src="{{asset('ecomas/images/products/orange-1.jpg')}}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{asset('ecomas/images/products/white-1.jpg')}}" src="{{asset('ecomas/images/products/white-1.jpg')}}" alt="image-product">
                                    </a>
