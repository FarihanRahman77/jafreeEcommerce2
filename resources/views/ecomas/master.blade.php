...
@include('ecomas.layouts.header')

<body class="preload-wrapper color-primary-2">
    <!-- RTL -->
    <!-- <a href="javascript:void(0);" id="toggle-rtl" class="tf-btn animate-hover-btn btn-fill">RTL</a> -->
    <!-- /RTL  -->
    @include('ecomas.layouts.preloader')
    <div id="wrapper">
        @include('ecomas.layouts.announcementbar')
        <!-- Header -->
        <header id="header" class="header-default header-style-2">
            @include('ecomas.layouts.topbar')
            <!-- @include('ecomas.layouts.menubar') -->
            
        </header>
        <!-- /Header -->
        @yield('content')
        @include('ecomas.layouts.footer')
        
    </div>
    
    @include('ecomas.layouts.gotop')
    ...
    <!-- canvasSearch -->
    @include('ecomas.layouts.searchbar')
    <!-- /canvasSearch -->
    ...
    <!-- shoppingCart -->
    @include('ecomas.layouts.shoppingCart')
    <!-- /shoppingCart -->
    ...
    @include('ecomas.layouts.productDetails')
    <!-- /modal quick_view -->
