...
@section('title')
Admin Product Special Deals -View
@endsection
@section('content')
<div class="content-wrapper">
    <section class="content-header" style="padding: 0px 1.0rem;">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3>Create Products Special Deals</h3>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{url('/products/specialDealsAdd')}}" class="btn btn-success btn-icon-split">
                                <span class="icon text-white-50">
                                    <i class="fas fa-plus"></i>
                                </span>
                                <span class="text">Add Special Products Deals</span>
                            </a>
                            ...
                            <table id="tbl_category" class="table table-bordered table-striped dt_view">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 12%;">
                                            <a href="{{url('/productsSpecialDeals/delete/'.$productSpecialOfffer->id)}}" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Delete"><i class="fas fa-trash"> Delete</i></a>
                                        </td>
