            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <fieldset >
                            ...
                            <div class="col-md-12 row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-primary btn-flat float-right" ><i class="fa fa-save"></i> Save </button>
                                    </div>
                                </div>
                            </div>
                            {!!Form::close()!!}
                        ...
                        {!!Form::open(['url'=>'products/subCatUpdate','class'=>'form-horizontal' ,'method'=>'POST','enctype'=>'multipart/form-data'])!!}
                        <fieldset>
                            <legend>Add Sub Category</legend>
                            <input type="hidden" value="{{$id}}" name="id">
                            <div class="col-md-12 row">
                                <div class="form-group col-md-6">
                                    <label for="video_url" class="col-form-label">Category</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="video_url" class="col-form-label">Sub Category</label>
                                    <div class="col-sm-12">
                                        <select class="form-control" id="sub_category_id" name="sub_category_id" value="{{$product->sub_category_id}}" >
                                ...
                                <div class="form-group col-md-12">
                                    <label for="Productimage" class="col-form-label text-light">.</label>
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-primary btn-flat float-right" name="editProduct"><i class="fa fa-save"></i> Save </button>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <legend>Multiple Images</legend>
                            ...
                            <div class="col-md-12 row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="col-sm-12">
                                        <img src="" id="productimg" alt="No Image" width="180" height="110" />
                                    </div>
                                </div>
                                <div class="form-group col-md-1">
                                    <label for="Productimage" class="col-form-label text-light">.</label>
