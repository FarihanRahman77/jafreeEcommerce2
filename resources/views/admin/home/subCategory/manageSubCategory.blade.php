                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header ">
                            <span class="text">Add Sub-category Edit</span>
                        </div>
                        <h3 class="text-center text-success">{{Session::get('message')}}</h3>
                        <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-8">
                                {!!Form::open(['url'=>'sub-category/update','class'=>'form-horizontal' ,'method'=>'POST'])!!}
                                <input type="hidden" value="{{$subCategoryById->id}}" id="id" name="id">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="subCategoryname" value="{{$subCategoryById->subCategoryName}}" name="subCategoryname" placeholder="Sub Category name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" id="comments" name="comments" placeholder=" Write about category " >{{$subCategoryById->comments}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script>
   document.getElementById("CategoryName").value = "{{$subCategoryById->tbl_CategoryID}}";
   document.getElementById("subCategoryStatus").value = "{{$subCategoryById->status}}";
</script>
@endsection