                    ...
                    <div class="container">
                        <div class="mobile-header__body"><button class="mobile-header__menu-button"><svg width="18px"
                            ...
                            <div class="mobile-header__indicators">
                                ...
                                <div class="indicator indicator--mobile"><a href="{{ url('/card') }}"
                                        class="indicator__button"><span class="indicator__area"><svg width="20px"
                                                height="20px">
                                ...
                                <div class="nav-panel__nav-links nav-links">
                                    <ul class="nav-links__list">
                                        <li class="nav-links__item nav-links__item--with-submenu"><a
                                                href="{{ url('/') }}"><span>Home <svg class="nav-links__arrow" width="9px"
                                                        height="6px">
                                            ...
                                            <div class="dropcart">
                                                <div class="dropcart__products-list">
                                                    <div class="dropcart__product">
                                                        <div class="dropcart__product-image"><a href="{{ url('/products') }}"><img
                                                                    src="{{asset('website/images/products/product-1.jpg')}}" alt=""></a>
                                                        </div>
                                                        <div class="dropcart__product-info">
                                                            <div class="dropcart__product-name"><a
                                                                    href="{{ url('/products') }}">Electric Planer Brandix
                                                    ...
                                                    <div class="dropcart__product">
                                                        <div class="dropcart__product-image"><a href="{{ url('/products') }}"><img
                                                                    src="{{asset('website/images/products/product-2.jpg')}}" alt=""></a>
                                                        </div>
                                                        <div class="dropcart__product-info">
                                                            <div class="dropcart__product-name"><a
                                                                    href="{{ url('/products') }}">Undefined Tool IRadix DPS3000SY
                                                                    2700 watts</a></div>
                                                            <div class="dropcart__product-meta"><span
                                                    ...
                                                    <div class="dropcart__product">
                                                        <div class="dropcart__product-image"><a href="{{ url('/products') }}"><img
                                                                    src="{{asset('website/images/products/product-5.jpg')}}" alt=""></a>
                                                        </div>
                                                        <div class="dropcart__product-info">
                                                            <div class="dropcart__product-name"><a
                                                                    href="{{ url('/products') }}">Brandix Router Power Tool
                                                                    2017ERXPK</a></div>
                                                            <ul class="dropcart__product-options">
                                                ...
                                                <div class="dropcart__buttons"><a class="btn btn-secondary"
                                                        href="{{ url('/card') }}">View Cart</a> <a class="btn btn-primary"
                                                        href="{{ url('/checkoutcard') }}">Checkout</a></div>
                                            </div><!-- .dropcart / end -->
                                        </div>
                                    </div>
                                </div>
