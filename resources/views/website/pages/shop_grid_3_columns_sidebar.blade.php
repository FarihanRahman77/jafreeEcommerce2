...
@section('title')
Jafree Ecommerce - shop Grid 3 columns
@endsection
@section('content')
                                    ...
                                    <div class="products-list__body">
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__image"><a href="{{ url('/products') }}"><img
                                                            src="{{asset('website/images/products/product-1.jpg')}}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Electric
                                                            Planer Brandix KL370090G 300 Watts</a></div>
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__image"><a href="{{ url('/products') }}"><img
                                                            src="{{asset('website/images/products/product-2.jpg')}}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Undefined
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__image"><a href="{{ url('/products') }}"><img
                                                            src="{{asset('website/images/products/product-3.jpg')}}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Drill
                                                            Screwdriver Brandix ALX7054 200 Watts</a></div>
                                                    <div class="product-card__rating">
                                                        <div class="rating">
                                                            <div class="rating__body"><svg
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__image"><a href="{{ url('/products') }}"><img
                                                            src="{{asset('website/images/products/product-4.jpg')}}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Drill Series
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__image"><a href="{{ url('/products') }}"><img
                                                            src="{{asset('website/images/products/product-5.jpg')}}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Brandix
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Water Hose
                                                            40cm</a></div>
                                                    <div class="product-card__rating">
                                                        <div class="rating">
                                                            <div class="rating__body"><svg
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Spanner
                                                            Wrench</a></div>
                                                    <div class="product-card__rating">
                                                        <div class="rating">
                                                            <div class="rating__body"><svg
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__image"><a href="{{ url('/products') }}"><img
                                                            src="{{asset('website/images/products/product-10.jpg')}}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Water Tap</a>
                                                    </div>
                                                    <div class="product-card__rating">
                                                        <div class="rating">
                                                            <div class="rating__body"><svg
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__image"><a href="{{ url('/products') }}"><img
                                                            src="{{asset('website/images/products/product-11.jpg')}}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Hand Tool
                                                            Kit</a></div>
                                                    <div class="product-card__rating">
                                                        <div class="rating">
                                                            <div class="rating__body"><svg
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__image"><a href="{{ url('/products') }}"><img
                                                            src="{{asset('website/images/products/product-12.jpg')}}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Ash's
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__image"><a href="{{ url('/products') }}"><img
                                                            src="{{asset('website/images/products/product-13.jpg')}}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Brandix Angle
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__image"><a href="{{ url('/products') }}"><img
                                                            src="{{asset('website/images/products/product-14.jpg')}}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Brandix Air
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                ...
                                                <div class="product-card__image"><a href="{{ url('/products') }}"><img
                                                            src="{{asset('website/images/products/product-15.jpg')}}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">Brandix
