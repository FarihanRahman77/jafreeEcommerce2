                                                            ...
                                                            @foreach($categories as $category)
                                                                <li
                                                                    ...
                                                                    <svg class="filter-categories__arrow" width="6px"
                                                                        height="9px">
                                                                        <!-- <use
                                                                            xlink:href="{{asset('website/images/sprite.svg#arrow-rounded-left-6x9')}}">
                                                                        </use> -->
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card"><button class="product-card__quickview"
                                                    type="button"><svg width="16px" height="16px">
                                                        <use xlink:href="{{asset('website/images/sprite.svg#quickview-16')}}"></use>
                                                    </svg> <span class="fake-svg-icon"></span></button>
                                                <div class="product-card__badges-list">
                                                    <!-- <div class="product-card__badge product-card__badge--new">New</div> -->
                                                </div>
                                                <div class="product-card__image"><a href="{{ url('/products') }}">
                                                <img src="{{ $settings->erp_baseurl.'/images/products/thumb/'.$product->productImage }}" alt="">

                                                        </a>
                                                        </div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="{{ url('/products') }}">
                                                        {{$product->productName}}
                                                    </a></div>
                                                        ...
                                                        <div class="rating">
                                                            <div class="rating__body"><svg
                                                                    ...
                                                                    <g class="rating__fill">
                                                                        <use xlink:href="{{asset('website/images/sprite.svg#star-normal')}}">
                                                                        </use>
                                                                    </g>
                                                                    <g class="rating__stroke">
                                                                        <use
                                                                            xlink:href="{{asset('website/images/sprite.svg#star-normal-stroke')}}">
                                                                        </use>
                                                                    </g>
                                                                </svg>
                                                                <div
                                    ...
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li class="page-item"><a class="page-link page-link--with-arrow" href="#"
                                                aria-label="Next"><svg class="page-link__arrow page-link__arrow--right"
                                                    ...
                                                    <use xlink:href="{{asset('website/images/sprite.svg#arrow-rounded-right-8x13')}}"></use>
                                                </svg></a></li>
                                    </ul>
                                </div>
                            </div>
