                    ...
                    <div class="table-responsive">
                        <table class="compare-table">
                            <tbody>
                                <tr>
                                    <th>Product</th>
                                    <td><a class="compare-table__product-link" href="{{ url('/products') }}">
                                            <div class="compare-table__product-image"><img src="{{asset('website/images/products/product-1.jpg')}}" alt=""></div>
                                            <div class="compare-table__product-name">Electric Planer Brandix KL370090G 300 Watts</div>
                                        </a></td>
                                    <td><a class="compare-table__product-link" href="{{ url('/products') }}">
                                            <div class="compare-table__product-image"><img src="{{asset('website/images/products/product-2.jpg')}}" alt=""></div>
                                            <div class="compare-table__product-name">Undefined Tool IRadix DPS3000SY 2700 Watts</div>
                                        </a></td>
                                    <td><a class="compare-table__product-link" href="{{ url('/products') }}">
                                            <div class="compare-table__product-image"><img src="{{asset('website/images/products/product-3.jpg')}}" alt=""></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="compare-table__product-rating-legend">7 Reviews</div>
                                    </td>
                                    <td>
                                        <div class="compare-table__product-rating">
                                            <div class="rating">
