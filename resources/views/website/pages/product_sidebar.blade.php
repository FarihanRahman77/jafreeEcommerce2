...
@section('title')
Jafree Ecommerce - Product Sidebar
@endsection
@section('content')
                            ...
                            <ul class="widget-categories__list" data-collapse data-collapse-opened-class="widget-categories__item--open">
                                <li class="widget-categories__item" data-collapse-item>
                                    <div class="widget-categories__row"><a href="#"><svg class="widget-categories__arrow" width="6px" height="9px">
                                                <use xlink:href="images/sprite.svg#arrow-rounded-right-6x9"></use>
                                            </svg> Power Tools </a><button class="widget-categories__expander" type="button" data-collapse-trigger></button></div>
                                    <div class="widget-categories__subs" data-collapse-content>
                                        <ul>
                                            <li><a href="#">Engravers</a></li>
                                            <li><a href="#">Drills</a></li>
                                            <li><a href="#">Wrenches</a></li>
                                            <li><a href="#">Plumbing</a></li>
                                            <li><a href="#">Wall Chaser</a></li>
                                            <li><a href="#">Pneumatic Tools</a></li>
                                ...
                                <li class="widget-categories__item" data-collapse-item>
                                    <div class="widget-categories__row"><a href="#"><svg class="widget-categories__arrow" width="6px" height="9px">
                                                <use xlink:href="images/sprite.svg#arrow-rounded-right-6x9"></use>
                                            </svg> Hand Tools </a><button class="widget-categories__expander" type="button" data-collapse-trigger></button></div>
                                    <div class="widget-categories__subs" data-collapse-content>
                                        <ul>
                                ...
                                <li class="widget-categories__item" data-collapse-item>
                                    <div class="widget-categories__row"><a href="#"><svg class="widget-categories__arrow" width="6px" height="9px">
                                                <use xlink:href="images/sprite.svg#arrow-rounded-right-6x9"></use>
                                            </svg> Garden Equipment </a><button class="widget-categories__expander" type="button" data-collapse-trigger></button></div>
                                    <div class="widget-categories__subs" data-collapse-content>
                                        <ul>
                                            <li><a href="#">Motor Pumps</a></li>
                                ...
                                <li class="widget-categories__item" data-collapse-item>
                                    <div class="widget-categories__row"><a href="#"><svg class="widget-categories__arrow" width="6px" height="9px">
                                                <use xlink:href="images/sprite.svg#arrow-rounded-right-6x9"></use>
                                            </svg> Machine Tools </a><button class="widget-categories__expander" type="button" data-collapse-trigger></button></div>
                                    <div class="widget-categories__subs" data-collapse-content>
                                        <ul>
                                            <li><a href="#">Thread Cutting</a></li>
                                            <li><a href="#">Chip Blowers</a></li>
                                            <li><a href="#">Sharpening Machines</a></li>
                                            <li><a href="#">Pipe Cutters</a></li>
                                            <li><a href="#">Slotting machines</a></li>
                                ...
                                <li class="widget-categories__item" data-collapse-item>
                                    <div class="widget-categories__row"><a href="#"><svg class="widget-categories__arrow" width="6px" height="9px">
                                                <use xlink:href="images/sprite.svg#arrow-rounded-right-6x9"></use>
                                            </svg> Instruments </a><button class="widget-categories__expander" type="button" data-collapse-trigger></button></div>
                                    <div class="widget-categories__subs" data-collapse-content>
                                        <ul>
                                            <li><a href="#">Welding Equipment</a></li>
                                            <li><a href="#">Power Tools</a></li>
                                            <li><a href="#">Hand Tools</a></li>
                                            <li><a href="#">Measuring Tool</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="widget-categories__item" data-collapse-item>
                            ...
                            <div class="product__gallery">
                                <div class="product-gallery">
                                    <div class="product-gallery__featured">
                                        <div class="owl-carousel" id="product-image"><a href="images/products/product-16.html" target="_blank"><img src="{{asset('website/images/products/product-16.jpg')}}" alt=""> </a><a href="images/products/product-16-1.html" target="_blank"><img src="{{asset('website/images/products/product-16-1.jpg')}}" alt=""> </a><a href="images/products/product-16-2.html" target="_blank"><img src="{{asset('website/images/products/product-16-2.jpg')}}" alt=""> </a><a href="images/products/product-16-3.html" target="_blank"><img src="{{asset('website/images/products/product-16-3.jpg')}}" alt=""> </a><a href="images/products/product-16-4.html" target="_blank"><img src="{{asset('website/images/products/product-16-4.jpg')}}" alt=""></a></div>
                                    </div>
                                    <div class="product-gallery__carousel">
                                        <div class="owl-carousel" id="product-carousel"><a href="#" class="product-gallery__carousel-item"><img class="product-gallery__carousel-image" src="{{asset('website/images/products/product-16.jpg')}}" alt=""> </a><a href="#" class="product-gallery__carousel-item"><img class="product-gallery__carousel-image" src="{{asset('website/images/products/product-16-1.jpg')}}" alt=""> </a><a href="#" class="product-gallery__carousel-item"><img class="product-gallery__carousel-image" src="{{asset('website/images/products/product-16-2.jpg')}}" alt=""> </a><a href="#" class="product-gallery__carousel-item"><img class="product-gallery__carousel-image" src="{{asset('website/images/products/product-16-3.jpg')}}" alt=""> </a><a href="#" class="product-gallery__carousel-item"><img class="product-gallery__carousel-image" src="{{asset('website/images/products/product-16-4.jpg')}}" alt=""></a></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="reviews-view__list">
                                        ...
                                        <div class="reviews-list">
                                            <ol class="reviews-list__content">
                                                ...
                                                <li class="reviews-list__item">
                                                    <div class="review">
                                                        <div class="review__avatar"><img src="{{asset('website/images/avatars/avatar-3.jpg')}}" alt=""></div>
                                                        <div class="review__content">
