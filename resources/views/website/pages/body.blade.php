            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="block block-banner">
                        <div class="custom-container"><div  class="block-banner__body">
                                ...
                                <div class="block-banner__button"><a href="{{ url('/shop/data') }}"><span class="btn btn-sm btn-primary text-light">Shop Now</span></a></div>
                            </div>
                        </div>
                                    ...
                                    <div class="product-card product-card--layout--horizontal">
                                        ...
                                        <div class="product-card__info">
                                            ...
                                            <div class="product-card__prices">
                                                <button class="btn btn-primary product-card__addtocart" type="button" onclick="addToCart({{$product->id}})"><span> <i class="fa fa-cart-arrow-down"></i></span></button> 
                                            </div>
                                        </div>
