...
@section('title')
Jafree Ecommerce - Post without sidebar
@endsection
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-9 col-xl-8">
                <div class="block post post--layout--full">
                    ...
                    <div class="post__featured"><a href="#"><img src="{{asset('website/images/posts/post-featured.jpg')}}" alt=""></a></div>
                    <div class="post__content typography typography--expanded">
                        <p>Vestibulum sagittis justo sit amet nisl semper, et pulvinar elit maximus. Morbi interdum velit quis magna placerat lobortis eget pharetra magna. Nulla tristique sollicitudin turpis, eget maximus risus faucibus non. Nulla vestibulum ipsum risus, vitae maximus nunc bibendum quis.</p>
                        <p>raesent eu consequat nibh. Quisque <i>ullamcorper</i>, augue eu fringilla sodales, leo metus volutpat risus, at suscipit ipsum diam eget sem. Maecenas dictum elit in enim molestie, <a href="#">vel sollicitudin erat ultricies</a>. Sed risus tellus, molestie finibus dui quis, suscipit consequat ex.</p>
                        <blockquote>
                        ...
                        <figure><a href="#"><img src="{{asset('website/images/posts/post-featured.jpg')}}" alt=""></a>
                        ...
                        <p>Phasellus ut elit vestibulum, dignissim mi non, suscipit ex. Praesent eu consequat nibh. Quisque ullamcorper, augue eu fringilla sodales, leo metus volutpat risus, <a href="#">at suscipit ipsum diam eget sem</a>. Maecenas dictum elit in enim molestie, vel sollicitudin erat ultricies. Sed risus tellus, molestie finibus dui quis, suscipit consequat ex.</p>
                        <hr>
                    ...
                    <div class="post__footer">
                        ...
                        <div class="post-author">
                            <div class="post-author__avatar"><a href="#"><img src="{{asset('website/images/avatars/avatar-1.jpg')}}" alt=""></a></div>
                    ...
                    <section class="post__section">
                        ...
                        <ol class="comments-list comments-list--level--0">
                            <li class="comments-list__item">
                                <div class="comment">
                                    <div class="comment__avatar"><a href="#"><img src="{{asset('website/images/avatars/avatar-1.jpg')}}" alt=""></a></div>
                                ...
                                <div class="comment-list__children">
                                    <ol class="comments-list comments-list--level--1">
                                        <li class="comments-list__item">
                                            <div class="comment">
                                                <div class="comment__avatar"><a href="#"><img src="{{asset('website/images/avatars/avatar-2.jpg')}}" alt=""></a></div>
                                                <div class="comment__content">
                                                    <div class="comment__header">
                                        ...
                                        <li class="comments-list__item">
                                            <div class="comment">
                                                <div class="comment__avatar"><a href="#"><img src="{{asset('website/images/avatars/avatar-3.jpg')}}" alt=""></a></div>
                                                <div class="comment__content">
                                                    <div class="comment__header">
                            ...
                            <li class="comments-list__item">
                                <div class="comment">
                                    <div class="comment__avatar"><a href="#"><img src="{{asset('website/images/avatars/avatar-4.jpg')}}" alt=""></a></div>
                                    <div class="comment__content">
                                        <div class="comment__header">
                    ...
                    <section class="post__section">
                        ...
                        <form>
                            ...
                            <div class="form-group mt-4"><button type="submit" class="btn btn-primary btn-lg">Post Comment</button></div>
                        </form>
                    </section>
                </div>
            </div>
